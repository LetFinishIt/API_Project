...
namespace FinalProjectAPI
{
    ...
    options.SerializerSettings.ReferenceLoopHandling = Newtonsoft.Json.ReferenceLoopHandling.Ignore);
            ...
            services.AddDbContext<FinalProjectDBContext>(options => options.UseSqlServer(Configuration.GetConnectionString("Connection2FinalProjectDB")));
            ...
            services.AddScoped<IUserCredRepository, UserCredRepository>();
